...
def main():
    ...
    url = 'https://docs.contrastsecurity.jp/ja/-net-framework-agent-release-notes-and-archive.html'
    res = req.urlopen(url)
    ...
    feed = Rss201rev2Feed(
        title='.NET Framework Agent Release Note',
        link='https://contrastsecurity.dev/contrast-documentation-rss',
        description='.NET Framework Agent Release Note',
        language='ja',
        author_name="Contrast Security Japan G.K.",
        feed_url='https://contrastsecurity.dev/contrast-documentation-rss/dotnet_framework_rlsnote.xml',
    ...
    with open('/feeds/dotnet_framework_rlsnote.xml','w') as fp:
