...
def main():
    url = 'https://docs.contrastsecurity.jp/ja/go-supported-technologies.html'
    res = req.urlopen(url)
    ...
    feed = Rss201rev2Feed(
        title='Go Supported Technologies',
        link='https://contrastsecurity.dev/contrast-documentation-rss',
        description='Go Supported Technologies',
        language='ja',
        author_name="Contrast Security Japan G.K.",
        feed_url='https://contrastsecurity.dev/contrast-documentation-rss/go_support_tech_update.xml',
    ...
    for elem in elems:
        try:
            ...
            url = 'https://docs.contrastsecurity.jp/ja/go-supported-technologies.html#%s' % id_str
            guid = 'https://docs.contrastsecurity.jp/ja/go-supported-technologies.html#%s' % id_hash
            text_buffer = []
    ...
    if len(item_dict) > 0:
        ...
        with open('/feeds/go_support_tech_update.xml','w') as fp: 
