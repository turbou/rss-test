...
def main():
    url = 'https://docs.contrastsecurity.jp/ja/-net-framework-supported-technologies.html'
    res = req.urlopen(url)
    ...
    feed = Rss201rev2Feed(
        ...
        description='.NET Framework Supported Technologies',
        language='ja',
        author_name="Contrast Security Japan G.K.",
        feed_url='https://contrastsecurity.dev/contrast-documentation-rss/dotnet_framework_support_tech_update.xml',
    ...
    for elem in elems:
        try:
            ...
            url = 'https://docs.contrastsecurity.jp/ja/-net-framework-supported-technologies.html#%s' % id_str
            guid = 'https://docs.contrastsecurity.jp/ja/-net-framework-supported-technologies.html#%s' % id_hash
            text_buffer = []
    ...
    if len(item_dict) > 0:
        ...
        with open('/feeds/dotnet_framework_support_tech_update.xml','w') as fp: 
