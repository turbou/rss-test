...
def main():
    ...
    feed = Rss201rev2Feed(
        title='Node.js Agent Release Note',
        link='https://contrastsecurity.dev/contrast-documentation-rss',
        description='Node.js Agent Release Note',
        language='ja',
        author_name="Contrast Security Japan G.K.",
        feed_url='https://contrastsecurity.dev/contrast-documentation-rss/nodejs_rlsnote.xml',
    ...
    with open('/feeds/nodejs_rlsnote.xml','w') as fp:
